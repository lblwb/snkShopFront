  ...
  <div class="BlockTransfer">
    ...
    <div class="BlockTransferData"
      ...
      <div class="BlockTransferDataWrapper" v-if="recInfo.data_source">
        ...
        <span v-if="orderData.onc">Payment reference: {{ orderData.onc }}</span>
      </div>
    </div>
...
const recInfo = computed(() => props_data.recInfo);
const orderData = computed(() => props_data.orderData);
