<template>
  <div class="searchProduct">
    <div class="searchProductWrapper">
      <div class="searchProductBlock" style="">
        <div class="searchProductBlockWrapper" style="display: flex; align-items: center; gap: 10px;">
          <div class="searchProductBlockIcon" style="flex: 0;">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                  ...
                  stroke="#939397" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          <div class="searchProductBlockInput" style="
    display: flex;
    flex: auto;
">
            <div class="searchProductBlockInputBox" style="width: 100%; height: 100%;">
              <input type="text" placeholder="Finding Snickers sneakers"
                     style="" v-haptic-engine>
            </div>
          </div>
        </div>
      </div>
